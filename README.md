...
- Standard calculator (add, subtract, multiply, divide, percentage)
- Simple Interest calculator
- Compound Interest calculator
- Choose time period in years or months
- Shows the formula breakdown so you can see how the result was calculated
